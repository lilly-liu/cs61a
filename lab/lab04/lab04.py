...
def paths(m, n): #fix
    ...
    def count_partitions(x, y):
        if x == 0 and y == 0:
            ...
            return count_partitions(x-1, y) + count_partitions(x, y-1)
    return count_partitions(m-1, n-1)



def max_subseq(n, l): #do
    """
    ...
    if l == 0 or n == 0:
        ...
        return max(n%10 + max_subseq(n//10, l-1) * 10, max_subseq(n//10, l))
